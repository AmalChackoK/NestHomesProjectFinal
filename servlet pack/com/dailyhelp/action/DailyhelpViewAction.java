...
+"</div>"
	...
	ArrayList<Dailyhelpcategorybean>  category=null;    	                
	      try{
	    	  category=DailyhelpcategoryDAO.listAlldcb();
	      }catch (SQLException sql) {
			sql.printStackTrace();
		}
	     for(Dailyhelpcategorybean ob:category){
	    	 out.print("<option value='"+ob.getDcid()+"'>"+ob.getDccategory()+"</option>");
	     }
