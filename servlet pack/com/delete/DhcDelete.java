...
public class DhcDelete  extends HttpServlet{
...
+"</div>"
	...
	+"</div>"
	          		+"<form action='dhcdeleteaction' method='Post'>"
	          		+"<div class='div-2'>"
	          			+"<h3>flates</h3> <hr>");
	          			for(Dailyhelpcategorybean ob:dhcedite){
	               			out.print("<input type='hidden' name='dhcid' value='"+ob.getDcid()+"' />"
	               			+" Number<br><input type='text' name='Category' value='"+ob.getDccategory()+"' readonly />"
