...
public class FacilityViewAction extends HttpServlet{
...
+"</div>"
	...
	+"<form action='facility' method='Post'>"
		+"<div class='div-2'>"
			...
			+"Designation<br><input typ='text' name='des'><br>"
			+ "Duty<br><input type='text' name='Dauty' /><br>"
			+ "contact<br><input type='text' name='phone' /><br>"
